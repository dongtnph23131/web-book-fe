  ...
  return (
    <>
      <section className='grid items-center pb-8 pt-6 md:py-8 container gap-12'>
        <section className='mx-auto flex w-full max-w-[64rem] flex-col items-center justify-center gap-4 pb-8 pt-6 text-center md:pb-12 md:pt-10 lg:py-28'>
      ...
      {isLoading ? <>
        ...
        <h2 className='font-bold tracking-tighter lg:leading-[1.1] text-2xl md:text-3xl mt-5'>Top tìm kiếm</h2>
        ...
        <h2 className='font-bold tracking-tighter lg:leading-[1.1] text-2xl md:text-3xl mt-5'>Top lượt xem nhiều nhất</h2>
        <div className="bg-white">
          <div className="max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
              {dataView?.map(book => {
