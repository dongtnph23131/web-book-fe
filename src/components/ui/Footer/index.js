...
const Footer = () => {
  return (
    <footer className='w-full border-t bg-background mt-10 flex justify-between'>
      <div className="flex-2 text-left text-sm leading-loose text-muted-foreground gap-8 pb-8 pt-6 md:py-8 container">
        <Logo />
      </div>
